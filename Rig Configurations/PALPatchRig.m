...
classdef PALPatchRig < RigConfiguration
    ...
    methods
        ...
        function createDevices(obj)
            ...
            obj.addDevice('Red_LED', 'ANALOG_OUT.1', '', 'mV');   % output only
            obj.addDevice('Green_LED', 'ANALOG_OUT.2', '', 'mV');   % output only
            obj.addDevice('Blue_LED', 'ANALOG_OUT.3', '', 'mV');   % output only
        end
